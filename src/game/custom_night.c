...
void custom_night_draw(void)
{
	...
	for (int i = 0; i < 4; i++)
		object_draw_index_y(face_icons, face_pos[i][0], face_pos[i][1],
				    67, i);

	int bparms[8][4] = {
		{ 42, 225, 11, 0 },  { 205, 225, 11, 1 }, { 727, 225, 11, 0 },
		{ 889, 225, 11, 1 }, { 42, 479, 11, 0 },  { 205, 479, 11, 1 },
		{ 727, 479, 11, 0 }, { 889, 479, 11, 1 },
	};

	for (int i = 0; i < 8; i++)
		object_draw_index_x(
			buttons, bparms[i][0], bparms[i][1], bparms[i][2],
